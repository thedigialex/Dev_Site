            ...
            <header class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
                        ...
                        <ul class="mt-16 w-max">
                            <li>
                                <a class="group flex items-center py-3" href="#about">
                                    <span id="about-link" class="nav-text text-xs uppercase">About</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex items-center py-3" href="#experience">
                                    <span id="exp-link" class="nav-text text-xs uppercase">Experience</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex items-center py-3" href="#projects">
                                    <span id="projects-link" class="nav-text text-xs uppercase">Projects</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
                ...
                <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
                    <li class="mr-5 text-xs">
                        <a class="block hover:text-skillTitle" href="https://github.com/thedigialex" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)">
                    ...
                    <li class="mr-5 text-xs">
                        <a class="block hover:text-skillTitle" href="https://thedigialex.com" target="_blank" rel="noreferrer noopener" aria-label="My Website (opens in a new tab)">
                    ...
                    <li class="mr-5 text-xs">
                        <a class="block hover:text-skillTitle" href="https://www.linkedin.com/in/alejandro-martinez-10b5b0a8" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)">
            ...
            <main id="content" class="pt-24 lg:w-1/2 lg:py-24">
                ...
                <section id="experience" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" aria-label="Work experience">
                    ...
                    <div>
                        <ol class="group/list">
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    <header class="z-10 mb-2 mt-1 text-xs font-bold uppercase sm:col-span-2" aria-label="2018 to Present">2022 — Present</header>
                            ...
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    <header class="z-10 mb-2 mt-1 text-xs font-bold uppercase sm:col-span-2 aria-label="2018 to Present">2022 — October 2022</header>
                                    <div class="z-10 sm:col-span-6">
                                        <h3 class="font-medium leading-snug">
                                            <div>
                                                <a href="https://elinkdesign.com/" target="_blank" rel="noreferrer noopener" aria-label="Web Developer at eLink Design (opens in a new tab)">
                        ...
                        <div class="mt-12">
                            <a class="leading-tight font-semibold hover:text-skillTitle" aria-label="View Full Resume" href="https://thedigialex.com/wp-content/uploads/2023/12/Resume.pdf">
                ...
                <section id="projects" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" aria-label="Selected projects">
                    ...
                    <div>
                        ...
                        <div class="mt-12">
                            <a class="leading-tight font-semibold hover:text-skillTitle" aria-label="View Projects" href="https://thedigialex.com/projects/">
