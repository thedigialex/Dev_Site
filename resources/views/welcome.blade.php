...
<body class="antialiased" style="background-image: linear-gradient(to bottom, #633BEA , #EFAD70 );">
    <div id="dot-container" class="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
        <div class="bg-custom-blue lg:flex lg:justify-between lg:gap-4">
            <header class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
                <div>
                    <h1 class="text-6xl font-bold">Alejandro Martinez</h1>
                    <h2 class="mt-3 text-2xl">Full Stack Developer</h2>
                    <p class="mt-4 text-xl">I create outstanding and user-friendly digital interactions.</p>
                    <nav class="nav hidden lg:block" aria-label="In-page jump links">
                        <ul class="mt-16 w-max text-base">
                            <li>
                                <a class="group flex items-center py-3 hover:text-hoverText" href="#about">
                                    <span id="about-link" class="nav-text uppercase">About</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex items-center py-3 hover:text-hoverText" href="#experience">
                                    <span id="exp-link" class="nav-text uppercase">Experience</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex items-center py-3 hover:text-hoverText" href="#projects">
                                    <span id="projects-link" class="nav-text uppercase">Projects</span>
                                </a>
                            </li>
                        </ul>
                    </nav>
                ...
                <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
                    <li class="mr-5">
                        <a class="block hover:text-hoverText" href="https://github.com/thedigialex" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)">
                    ...
                    <li class="mr-5 text-xs">
                        <a class="block hover:text-hoverText" href="https://www.linkedin.com/in/alejandro-martinez-10b5b0a8" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)">
                    ...
                    <li class="mr-5 text-xs">
                        <a class="block hover:text-hoverText" href="https://thedigialex.com" target="_blank" rel="noreferrer noopener" aria-label="My Website (opens in a new tab)">
                    ...
                    <li>
                        <a class="block hover:text-hoverText" href="mailto:alejandro11raym@gmail.com" aria-label="Email">
            ...
            <main id="content" class="pt-24 lg:w-1/2 lg:py-24 ">
                <section id="about" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" aria-label="About me">
                    <h2 class="text-hoverText font-bold uppercase pb-4 text-lg">About</h2>
                    <div class="p-4">
                        <p class="mb-4 text-lg">In 2014, I embarked on an academic journey at the <span class="text-hoverText font-bold">University of Kentucky, majoring in Computer Science.</span> My academic pursuits were further enriched by minoring in Computer Engineering and Mathematics, a decision influenced by the significant overlap in coursework. My profound passion for programming was ignited when a favorite game of mine was discontinued, inspiring me to reconstruct it from scratch. This project was a pivotal moment in my career, laying the foundation for my future endeavors.</p>
                        <p class="mb-4 text-lg">Currently, I am dedicated to enhancing and maintaining client websites in my role. My career trajectory began as a Support Developer, quickly advancing to a Managerial position, and eventually evolving into a <span class="text-hoverText font-bold">Full Web Developer role.</span> My commitment to professional growth is paralleled by my personal dedication to continuous learning. </p>
                        <p class="mb-4 text-lg">In my leisure time, I immerse myself in various projects, constantly seeking new opportunities to broaden my technical expertise and knowledge.</p>
                    </div>
                </section>
                <section id="experience" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" aria-label="Work experience">
                    <h2 class="text-hoverText font-bold uppercase pb-4 text-lg">Experience</h2>
                    <div>
                        <ol class="group/list">
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    <header class="mb-2 mt-1 text-xs font-bold uppercase sm:col-span-2" aria-label="2018 to Present">2022 — Present</header>
                                    <div class="sm:col-span-6">
                                        ...
                                        <p class="mt-2 text-base leading-normal">In my role as a Mobile/Web Application Developer, I have been dedicated to delivering high-quality, robust production code for a diverse portfolio of projects. My work serves a wide range of esteemed clients, potentially including prestigious pharacmacy stores, healthcare companies, and impactful non-profits.</p>
                            ...
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    <header class="mb-2 mt-1 text-xs font-bold uppercase sm:col-span-2 aria-label=" 2018 to Present">2022 — October 2022</header>
                                    <div class="sm:col-span-6">
                                        <h3 class="font-bold uppercase leading-snug">
                                            <div>
                                                <a href="https://elinkdesign.com/" target="_blank" rel="noreferrer noopener" aria-label="Web Developer at eLink Design (opens in a new tab)">
                                                    <span class="experience-title">Support Developer · eLink Design
                                                    </span>
                                                </a>
                                            </div>
                                        </h3>
                                        <p class="mt-2 text-base leading-normal">As a Support Developer, my responsibilities will encompass a blend of technical proficiency and collaborative problem-solving. I will actively engage in diagnosing and resolving complex technical issues, leveraging my expertise in web development languages such as HTML, CSS, JavaScript, and PHP. My role will be crucial in maintaining the functionality and performance of web applications, ensuring responsiveness and cross-browser compatibility.</p>
                                        <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                                            <li class="mr-1.5 mt-2">
                        ...
                        <div class="mt-12">
                            <a class="leading-tight font-semibold text-white hover:text-hoverText" aria-label="View Full Resume" href="https://thedigialex.com/wp-content/uploads/2023/12/Resume.pdf">
                ...
                <section id="projects" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 section" aria-label="Selected projects">
                    <h2 class="text-hoverText font-bold uppercase pb-4 text-lg">Projects</h2>
                    <div>
                        <ul class="group/list">
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                            ...
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        <p class="mt-2 text-base leading-normal">Website Checker, a powerful tool designed for effortless website analysis. With its user-friendly interface, users can input multiple website URLs to swiftly assess their response codes. But that’s not all – the app goes above and beyond by enabling users to integrate their Google Analytics key. This integration empowers users to comprehensively evaluate their website’s SEO performance, page speed, and accessibility. </p>
                                        <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">Android Studio</div>
                                            </li>
                                            ...
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">API Calls</div>
                                            </li>
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">XML</div>
                                            </li>
                            ...
                            <li class="mb-12">
                                <div class="group experience-div hover:bg-hoverBackground">
                                    ...
                                    <div class="sm:col-span-6">
                                        ...
                                        <p class="mt-2 text-base leading-normal">This WordPress site is a specialized platform to hold family recipes, featuring a robust user authentication system for secure access. It utilizes a custom post type exclusively for recipes, ensuring a unique and organized presentation. Users can submit their own recipes through an intuitive interface, and these submissions are displayed using custom templates.</p>
                                        <ul class="mt-2 flex flex-wrap" aria-label="Technologies used">
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">WordPress</div>
                                            </li>
                                            ...
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">Custom Templates</div>
                                            </li>
                                            <li class="mr-1.5 mt-2">
                                                <div class="skill-badge">Custom Post Types</div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="mt-12">
                            <a class="leading-tight font-semibold text-white hover:text-hoverText" aria-label="View Projects" href="https://thedigialex.com/projects/">
